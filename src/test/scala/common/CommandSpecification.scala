...
import io.multiverse.domain.aggregates.common.{TailCommand, UnconditionalTailCommand, ConditionalTailCommand, HeadCommand, CommandPrerequisite, DynamicCommand, AggregateRoot}
...
trait CommandSpecification extends Specification {
   ...
   * @return Match result.
   */
  protected def assertIdempotent[A <: AggregateRoot[A, E], E, C <: DynamicCommand[A, E, C] with TailCommand[A, E]](aggregate: A, command: C) = {
